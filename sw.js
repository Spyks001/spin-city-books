const CACHE="spin-city-books-v14";
const SHELL=["./","./manifest.webmanifest","./assets/spin-city-logo.webp","./branding.js","./transaction-audit.js"];
async function cacheShell(){
  ...
  try{
    ...
    if(r.ok){
      ...
      if(!html.includes('transaction-audit.js')) html=html.replace(/<\/body>/i,'<script src="./transaction-audit.js?v=14"></script></body>');
